...
function authn (){
    ...
    httpGet('/getPendingRequest', undefined, Config.clientId, Config.clientSecret)
        .then(r => {
            ...
            if (r.body.data.result != false) {
                ...
                completeLogin(sigReq, {
                    ...
                    .then(r => {
                        ...
                        console.log("completelogin response:", r.status, r.body)
...
process.on('message', function (data) {
    console.log("9999999", login_name, data, parseInt(data.data.respondTo))
    authn()
    pm2.connect(function () {
        /*
        pm2.sendDataToProcessId(data.respondTo, {
        ...
        */
        pm2.sendDataToProcessId(data.data.respondTo, {
            data: {
                login:login_name},
            //id: pm2_worker_ids[p],
            topic: 'process:msg'
